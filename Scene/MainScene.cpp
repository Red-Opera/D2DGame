...
MainScene::MainScene(class Context* const context) : Scene(context)
{
	timer = context->GetSubSystem<Timer>();
	context->GetSubSystem<ScoreUI>()->Reflash();
	context->GetSubSystem<PressUI>()->Reflash();

	camera->GetComponent<TransformComponent>()->SetPosition(D3DXVECTOR3(-500.0f, -80.0f, 5.0f));
	...
	animator->SetCurrentAnimation("LeftIdle");
