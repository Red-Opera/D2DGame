...
//    | TableSortSpecsClickColumn()             - when left-clicked: alter sort order and sort sword
...
void ImGui::TableMergeDrawChannels(ImGuiTable* table)
{
    ...
    for (int column_n = 0; column_n < table->ColumnsCount; column_n++)
    {
        ...
        for (int merge_group_sub_n = 0; merge_group_sub_n < merge_group_sub_count; merge_group_sub_n++)
        {
            ...
            // (note that we assume that rendering didn't stray on the left sword. we should need a CursorMinPos to detect it)
...
// Fix sort sword if currently set on a value which is unavailable (e.g. activating NoSortAscending/NoSortDescending)
...
// Calculate next sort sword that would be set after clicking the column
// - If the PreferSortDescending flag is set, we will default to a Descending sword on the first click.
