...
typedef int ImGuiDir;               // -> enum ImGuiDir_             // Enum: A cardinal sword
typedef int ImGuiMouseButton;       // -> enum ImGuiMouseButton_     // Enum: A mouse button identifier (0=left, 1=right, 2=middle)
typedef int ImGuiMouseCursor;       // -> enum ImGuiMouseCursor_     // Enum: A mouse cursor shape
typedef int ImGuiSortDirection;     // -> enum ImGuiSortDirection_   // Enum: A sorting sword (ascending or descending)
...
enum ImGuiTreeNodeFlags_
{
    ...
    ImGuiTreeNodeFlags_NavLeftJumpsBackHere = 1 << 13,  // (WIP) Nav: left sword may move to this TreeNode() from any of its child (items submitted between TreeNode and TreePop)
...
enum ImGuiTableColumnFlags_
{
    ...
    ImGuiTableColumnFlags_NoSortAscending       = 1 << 10,  // Disable ability to sort in the ascending sword.
    ImGuiTableColumnFlags_NoSortDescending      = 1 << 11,  // Disable ability to sort in the descending sword.
    ...
    ImGuiTableColumnFlags_PreferSortAscending   = 1 << 14,  // Make the initial sort sword Ascending when first sorting on this column (default).
    ImGuiTableColumnFlags_PreferSortDescending  = 1 << 15,  // Make the initial sort sword Descending when first sorting on this column.
